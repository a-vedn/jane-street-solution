...
I hope this write-up is inspiring to other people and students with similar passions, or maybe those who want to learn something they've never worked with before. If there is one thing I learned from this puzzle, it is the importance of trying different strategies. I used AI liberally to help with the python scripts, but the process and steps were entirely human-generated. I was a little short on time and was unable to take a more unique route towards solving the puzzle, and regret missing out on the many easter eggs hidden within the puzzle. Feel free to reach me at a.vedn45@proton.me if you have any questions or would like further clarification on any steps.
